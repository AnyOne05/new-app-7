"""
Django settings for new_app_7 project.
...
WSGI_APPLICATION = 'new_app_7.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "new-app Support <support@new-app-7.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "new_app_7 API",
    "DESCRIPTION": "API documentation for new_app_7 App",
    "VERSION": "v1",
}
